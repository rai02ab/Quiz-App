package com.asics.question_service.Controller;
...
import com.asics.question_service.Service.QuestionService;
...
public class QuestionController {
	...
	public ResponseEntity<List<Integer>> getQuestionsForQuiz(@RequestParam String categoryName){
		return questionService.getQuestionForQuiz(categoryName);
	}
